    ...
    <Wrapper>
      ...
      <div className="landing-container" data-testid="about-container">
        <div
          className="landing"
          style={{
            background: `radial-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.1)), url(/images/stars5.jpeg)`,
          }}
        >
        ...
        <section id="about" className="landing sidebyside">
          <div>
            ...
            <p className="subtitle">
              Alldrit Technologies is owned by Devin Alldrit, ex-founder/CTO of a recently acquired
              tech startup:&nbsp;
              <a
                href="https://afino.io"
                target="_blank"
              ...
              <br />
              <br />
              With over 4 years of experience and 15+ projects launched we have the expertise to
        ...
        <div id="fardown">
          <section className="landing sidebyside">
            <div>
              ...
              <p className="subtitle">
                Reach out with a brief summary of what your looking for and we&apos;ll setup a quick
                call to see if it&apos;s something we can do
              </p>
              <Link to="/contact">
